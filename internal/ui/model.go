...
import (
	...
	"github.com/protonmailis16/asgharscanner/internal/banner"
	"github.com/protonmailis16/asgharscanner/internal/config"
...
func getConfigFilePath() string {
	...
	if err != nil {
		return "asgharscanner-config.json"
	}
	appDir := filepath.Join(dir, "asgharscanner")
...
func (m AppModel) viewAbout() string {
	...
	sb.WriteString(banner.Render(m.bannerFrame / 2))
	sb.WriteRune('\n')
	sb.WriteString(styleTitle.Render("  asghar Scanner\n"))
	...
	sb.WriteString(styleDim.Render("  github.com/protonmailis16/asgharscanner"))
	sb.WriteString("\n\n")
...
func (m AppModel) exportAllConfigs() string {
	...
	subPath := filepath.Join(dir, "asgharscanner-sub.txt")
	...
	sbPath := filepath.Join(dir, "asgharscanner-singbox.json")
	...
	clashPath := filepath.Join(dir, "asgharscanner-clash.yaml")
